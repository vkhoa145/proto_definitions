...
const file_api_common_error_proto_rawDesc = "" +
	"\n" +
	"\x16api/common/error.proto\x12\tcommon.v1\"5\n" +
	"\x05Error\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessageB@Z>github.com/vkhoa145/proto_definition/gen/go/common/v1;commonv1b\x06proto3"

var (
	file_api_common_error_proto_rawDescOnce sync.Once
	file_api_common_error_proto_rawDescData []byte
)

func file_api_common_error_proto_rawDescGZIP() []byte {
	file_api_common_error_proto_rawDescOnce.Do(func() {
		file_api_common_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_common_error_proto_rawDesc), len(file_api_common_error_proto_rawDesc)))
	})
	return file_api_common_error_proto_rawDescData
}

var file_api_common_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_common_error_proto_goTypes = []any{
...
func file_api_common_error_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_common_error_proto_rawDesc), len(file_api_common_error_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
